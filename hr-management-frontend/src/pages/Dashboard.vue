...
const totalOrders = computed(
    () => dashboardStore.summary?.total_transactions || 0,
)
const totalProfit = computed(() => dashboardStore.summary?.net_profit || 0)
const totalExpenses = computed(
    () => dashboardStore.summary?.total_expenses || 0,
)
    ...
    <AuthenticatedLayout>
        ...
        <div class="mb-6">
            <div
                ...
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div
                        class="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
                        <button
        ...
        <div
            ...
            <div class="flex flex-col items-center">
                <!-- Green spinner -->
                <div
                    class="animate-spin h-14 w-14 rounded-full border-4 border-green-500 border-t-transparent"></div>
        ...
        <div
            ...
            class="bg-rose-50 border border-rose-200 rounded-lg p-4">
        ...
        <div v-else>
            ...
            <div
                ...
                <!-- Total Sales Card -->
                <div
                    class="bg-gray-100 rounded-xl p-6 border border-gray-300 hover:shadow-xl transition-shadow duration-300 shadow-md">
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <p
                                class="text-4xl font-extrabold text-gray-900 mt-2">
                        ...
                        <!-- Icon Section -->
                        <div
                            class="bg-gradient-to-br from-yellow-400 to-yellow-500 text-white p-4 rounded-2xl shadow-md">
                            <svg
                                class="w-7 h-7"
                                fill="none"
                                stroke="currentColor"
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <!-- Icon Section -->
                        <div
                            class="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white p-4 rounded-2xl shadow-md">
                            <svg
                                class="w-7 h-7"
                                fill="none"
                                stroke="currentColor"
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <!-- Icon Section -->
                        <div
                            class="bg-gradient-to-br from-rose-500 to-rose-600 text-white p-4 rounded-2xl shadow-md">
                            <svg
                                class="w-7 h-7"
                                fill="none"
                                stroke="currentColor"
                ...
                <!-- Total Profit Card -->
                <div
                    class="bg-green-600 rounded-xl p-6 border border-green-300 hover:shadow-xl transition-shadow duration-300 shadow-md">
                    <div class="flex items-center justify-between">
                        <!-- Text Section -->
                        <div>
                            <p
                        ...
                        <!-- Icon Section -->
                        <div
                            class="bg-gradient-to-br from-green-500 to-green-600 text-white p-4 rounded-2xl shadow-md">
                            <svg
                                class="w-7 h-7"
                                fill="none"
                                stroke="currentColor"
            ...
            <div
                ...
                <h3 class="text-lg font-semibold text-green-600 uppercase mb-4">
                    Sales Trend
                </h3>
                <div class="h-80">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div
                    class="lg:col-span-7 bg-gray-100 border border-gray-300 rounded-lg shadow-md p-6">
                    <h3
                        class="text-lg font-semibold text-yellow-600 uppercase mb-4">
                        Sales Report
                    </h3>
                    <div class="h-80">
                        <Line
                                    ...
                                    formatCurrency(
                                        totalSales /
                                            (dashboardStore.dashboard
                                                ?.sales_trend.length || 1),
                                    )
                                }}
                            </p>
                        </div>
                        <div
                            class="bg-green-700 border border-green-300 rounded-lg p-4">
                ...
                <div
                    class="lg:col-span-5 bg-gray-100 border border-gray-300 rounded-lg shadow-md p-6">
                    <h3
                        class="text-sm font-semibold text-red-700 uppercase mb-4">
                        Profit & Loss
                    </h3>
                    <div class="h-64">
                        <Pie
                            :data="profitLossPieData"
                            :options="profitLossPieOptions" />
                    </div>

                    <!-- P&L Summary -->
                    <div
                        v-if="dashboardStore.profitLoss"
                        ...
                        <div
                            ...
                            <span
                                ...
                                {{
                                    formatCurrency(
                                        dashboardStore.profitLoss.gross_profit,
                                    )
                                }}
                            </span>
                        </div>
                        ...
                        <div class="flex justify-between items-center pt-2">
                            ...
                            <span class="text-lg font-bold text-black">
                                {{
                                    formatCurrency(
                                        dashboardStore.profitLoss.net_profit,
                                    )
                                }}
                            </span>
                        </div>
                        <div
                            class="flex justify-between items-center bg-green-100 rounded-md border border-green-300 p-3">
                            <span class="text-sm text-gray-600"
                                >Profit Margin</span
                            >
